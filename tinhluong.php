            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Kết Lương</h6>
                        <a href="add/addtl.php" class="btn btn-primary">
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                ...
                                <th scope="col">Mã Tính Lương</th>
                                    ...
                                    <th scope="col">Số lương thực tế nhận</th>
                         ...
                         <td><?php echo $row["maTL"] ?></td>
                                ...
                                <td><?php $Luong = ($row["soLuong"]+ $row["soTien"]) / $row["ngayCongChuan"] * $row["soNgayLam"] - 500000*$row["soNgayNghiKhongPhep"];
                                    echo round("$Luong")." VND"; ?>
                                <td>
                        <!-- Button Sửa -->
                        <a href="edit/edittl.php?id=<?php echo $row['maTL']; ?>" id="btnUpdate" class="btn btn-primary">
                        <i class="fas fa-edit">Sửa</i>
                    </a>

                        <!-- Button Xóa -->
                        <a href="delete/deletetl.php?id=<?php echo $row['maTL']; ?>" id="btnDelete" class="btn btn-danger">
