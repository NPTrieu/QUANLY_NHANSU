            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Danh Sách Và Thông Tin Nhân Viên</h6>
                                
                        <a href="add/addnv.php" class="btn btn-primary">
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                             ...
                             <tr>
                                    ...
                                    <td><?php echo $row["trinhDoChuyenMon"]?></td>
                                    <td><?php echo $row["tenLoaiPhuCap"]?></td>
                                    <td>
                            <!-- Button Sửa -->
                            <a href="edit/editnv.php?id=<?php echo $row['maNV']; ?>"  id="btnUpdate" class="btn btn-primary">
                            <i class="fas fa-edit">Sửa</i>
                        </a>

                            <!-- Button Xóa -->
                            <a href="delete/deletenv.php?id=<?php echo $row['maNV']; ?>" id="btnDelete" class="btn btn-danger">
